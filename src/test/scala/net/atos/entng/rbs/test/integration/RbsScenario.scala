...
object RbsScenario {
  ...
  def getSlotAsStringBody(slot: Tuple2[Long, Long]): Body = {
    return StringBody("""{"slots" : [{"start_date" : """ + slot._1 + """, "end_date" : """ + slot._2 + """, "iana":"Europe/Paris" }]}""")
  }
...
//        .check(status.is(409)))
      ...
      .exec(http("Create periodic booking")
        ...
        .body(StringBody("""{"booking_reason":"Résa périodique",
            "slots":[{"start_date" : """ + pSlotStartDate + """, "end_date" : """ + pSlotEndDate + """, "iana":"Europe/Paris"}],
      ...
      .exec(http("List bookings and check their dates")
        .get("/rbs/resource/${resourceId}/bookings")
        .check(status.is(200),
          jsonPath("$[?(@.id == ${slotsIds(0)} && @.start_date == '2030-11-01T09:30:00.000')]").exists ,
          jsonPath("$[?(@.id == ${slotsIds(0)} && @.end_date == '2030-11-01T16:30:00.000' )]").exists ,
          jsonPath("$[?(@.id == ${slotsIds(1)}  && @.start_date == '2030-11-11T09:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(1)} && @.end_date == '2030-11-11T16:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(2)} && @.start_date == '2030-11-14T09:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(2)} && @.end_date == '2030-11-14T16:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(3)} && @.start_date == '2030-11-15T09:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(3)} && @.end_date == '2030-11-15T16:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(4)} && @.start_date == '2030-11-25T09:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(4)} && @.end_date == '2030-11-25T16:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(5)} && @.start_date == '2030-11-28T09:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(5)} && @.end_date == '2030-11-28T16:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(6)} && @.start_date == '2030-11-29T09:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(6)} && @.end_date == '2030-11-29T16:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(7)} && @.start_date == '2030-12-09T09:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(7)} && @.end_date == '2030-12-09T16:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(8)} && @.start_date == '2030-12-12T09:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(8)} && @.end_date == '2030-12-12T16:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(9)} && @.start_date == '2030-12-13T09:30:00.000')]").exists,
          jsonPath("$[?(@.id == ${slotsIds(9)} && @.end_date == '2030-12-13T16:30:00.000')]").exists))
